...
result = course[0:15]
result = course[:15]
#bu iki yazım aynı outputu verir
result = course[-15:]

# 5- 'course' ifadesindeki karakterleri tersten yazdırın.

result = course[::-1]
#bütün karakterleri al ama sağdan sola git --> -1 sayesinde oldu

##başka bi örnek gösterelim
s = '12345' * 4
print(s)
##12345123451234512345
print(s[::5])
#5 karakterde bir yazılan karakteri al ve bastır
##1111  --> index 0dan başlıyo o yüzden 1leri yazdırıyo
